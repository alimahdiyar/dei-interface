...
import { useBorrowPoolByContract, useCurrenciesFromPool } from 'state/borrow/hooks'
import { useSupportedChainId } from 'hooks/useSupportedChainId'

import { Balances, Borrow, Info, Position } from 'components/App/Borrow'
...
export default function BorrowDEI() {
  ...
  const pool = useBorrowPoolByContract(chainId ? veLender[chainId] : undefined, undefined)
